            ...
            <div class="footer__contact">
              <div class="footer__social">
                ...
                <div class="footer__validation">
                    <h3>Este sitio ha sido validado</h3>
                    <a href="https://validator.w3.org/nu/?doc=http%3A%2F%2Falexballera.com%2F" target="_blank">
                        <img src="http://i0.wp.com/web.alexballera.com/wp-content/uploads/2016/03/valid-html5.png?w=75" alt="Valid HTML" title="Validate HTML5" />
                    </a>
                    <a href="https://validator.w3.org/unicorn/check?ucn_uri=alexballera.com&doctype=Inline&charset=(detect%20automatically)&ucn_lang=es&ucn_task=conformance#" target="_blank">
                        <img src="http://i2.wp.com/web.alexballera.com/wp-content/uploads/2016/03/W3C_CSS_certified.png?w=75" alt="Valid CSS" title="Validate CSS3" />
                    </a>
                    <a href="http://validator.w3.org/feed/check.cgi?url=http%3A//web.alexballera.com/feed/" target="_blank">
                        <img src="http://i2.wp.com/web.alexballera.com/wp-content/uploads/2016/03/valid-rss-rogers.png?w=75" alt="Valid Atom" title="Validate RSS" />
                    </a>
                </div>
